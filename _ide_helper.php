...
namespace Illuminate\Support\Facades {
     ...
     */        class Route {
        ...
        {
                        return \Illuminate\Routing\Router::ValidationLaravelUser($prefix);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\Router::ValidationLaravelAdmin($prefix);
        }
                    /**
         * 
         *
         * @see \Yormy\TripwireLaravel\Routes\AdminRoutes::register()
         * @param string $prefix
         * @return void 
         * @static 
         */        public static function TripwireAdminSystemRoutes($prefix = '')
        {
                        \Illuminate\Routing\Router::TripwireAdminSystemRoutes($prefix);
        }
                    /**
         * 
         *
         ...
         * @return void 
         * @static 
         */        public static function TripwireAdminRoutes($prefix = '')
        {
                        \Illuminate\Routing\Router::TripwireAdminRoutes($prefix);
        }
                    /**
         * 
         *
         ...
         * @return void 
         * @static 
         */        public static function TripwireAdminMemberRoutes($prefix = '')
        {
                        \Illuminate\Routing\Router::TripwireAdminMemberRoutes($prefix);
        }
                    /**
         * 
         *
         ...
         * @return void 
         * @static 
         */        public static function TripwireAdminAdminRoutes($prefix = '')
        {
                        \Illuminate\Routing\Router::TripwireAdminAdminRoutes($prefix);
        }
                    /**
         * 
         *
         * @see \Yormy\TripwireLaravel\Routes\GuestRoutes::register()
         * @param string $prefix
         * @return void 
         * @static 
         */        public static function TripwireResetRoutes($prefix = '')
        {
                        \Illuminate\Routing\Router::TripwireResetRoutes($prefix);
        }
            }
            /**
     * 
